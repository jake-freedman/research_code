...
# ── theory mode (SOURCE = 'theory') ───────────────────────────────────────────
BETA1    = 1.17     # ch1 modulation depth (rad), drive at f
BETA2    = 1.39     # ch2 modulation depth (rad), drive at 2f
PHI1_DEG = 0.0      # ch1 phase (deg)
PHI2_DEG = -90.0    # ch2 phase (deg)
...
DATA_PATH = r"C:\Users\jake\OneDrive - UCB-O365\quantum_nanophoxonics\projects\dual_tone_aom\data\w3_d2-3_wg5b_p5\second_flat_phase_sweep_data_9orders.npz"
...
BAR_ALPHA_MAX = 0.85   # opacity at the bar's value (bar's top)
...
PUBLICATION_SVG_NAME = 'comb_displayer_flat5.svg'
# ─────────────────────────────────────────────────────────────────────────────
